...
export const ChatInput = ({
  ...
  return (
    <div className="absolute bottom-0 left-0 w-full border-transparent bg-gradient-to-b from-transparent via-white to-white pt-6 dark:border-white/20 dark:via-[#343541] dark:to-[#343541] md:pt-2">
      <div className="stretch mx-2 mt-4 flex flex-col gap-1 last:mb-2 md:mx-4 md:mt-[52px] md:last:mb-6 lg:mx-auto lg:max-w-3xl">
        {messageIsStreaming && (
          <button
        ...
        {!selectedConversation ||
          (selectedConversation.messages.length === 0 && (
            <div className="relative p-4 px-6 flex w-full flex-grow flex-col">
              <Onboarding
                onPromptSelected={(prompt: string) => {
                  onSend({ role: 'user', content: prompt }, plugin);
                }}
              />
            </div>
          ))}
